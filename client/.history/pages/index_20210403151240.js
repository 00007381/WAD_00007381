...
const HomePage = () => {
  ...
  return (
    <Layout>
      <div className="flex items-center text-xl text-gray-700 my-4 justify-between">
      ...
      {error && (
        <div>
          failed to load the data, problem is with the server, make sure to run
          the server or check console for more info
        </div>
      )}
